  ...
  return (
    <div className='about-me d-flex flex-column flex-md-row' id='about-me'>
      <div className='col-12 col-md-7' data-aos="fade-right" data-aos-duration="1500">
        <div className='image' style={{backgroundImage: "url('/preview/ferminpacheco.site/images/portfolio-person.jpg')"}}>
      ...
      <div className='col-12 col-md-5 content' data-aos="fade-left" data-aos-duration="1500">
        ...
        <div className='button-container'>
          <button className='hire-me'><a href="#contact">hire me</a></button>
          <button className='download'><a href="CurriculumPdf.pdf" download="FerminPachecoCV">download cv</a></button>
        </div>
      </div>
    </div>
  )
